import styles from './MacProduct.module.scss';
...
function MacProduct() {
    ...
    const [imageURL, setImageURL] = useState(
        'https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/Products/Images/44/302150/s16/mac-pro-16-m2-xam-650x650.png',
    );
        ...
        <div className={cx('wrapper')}>
            <div className={cx('inner-wrapper')}>
                ...
                <div className={cx('detail-product')}>
                    <h1 className={cx('title-product')}>MacBook Pro 16 inch 2023 M2 Pro 12CPU - 19GPU</h1>
                    ...
                    <div className={cx('color-product')}>
                        ...
                        <ColorButton
                            ...
                            onClick={() =>
                                handleColorChange(
                                    'Titan trắng',
                                    'https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/Products/Images/44/302150/s16/mac-pro-16-m2-bac-650x650.png',
                                )
                            }
                        ></ColorButton>
                    </div>
